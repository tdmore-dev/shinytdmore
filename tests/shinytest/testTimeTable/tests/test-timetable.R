...
app$snapshotInit("test-timetable")
...
app$waitFor(paste0( "$('#hot-table .ht_master .htCore tbody tr').length == ", (Nstart+15)), timeout=15*PlotSleep*1000)
app$executeScript("return( $('#hot-table .ht_master .htCore tbody tr').length );" )
